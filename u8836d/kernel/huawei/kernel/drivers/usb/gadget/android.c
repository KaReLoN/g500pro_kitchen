...
#define HQ_USB_MANUFACTURER_NAME "Huawei^Incorporated"
...
#define HQ_USB_PRODUCT_NAME "Huawei^Incorporated^GSM^Handset"
...
#define HQ_USB_MS_VENDOR "Huawei"
...
#define HQ_USB_MS_PRODUCT "U8836D"
