...
static struct i2c_board_info __initdata i2c_bma250={ I2C_BOARD_INFO("BMA250", (0x30>>1))};  //0x30  //longxuewei
...
static int BMA250_SetPowerMode(struct i2c_client *client, bool enable)
{
	...
	GSE_LOG("BMA250_SetPowerMode ok!,enable=%d\r\n",enable);
	mdelay(20);
...
/*----------------------------------------------------------------------------*/
char * bma250_i2c_probe_not_called = "bma250_i2c_probe_not_called";
EXPORT_SYMBOL(bma250_i2c_probe_not_called);
