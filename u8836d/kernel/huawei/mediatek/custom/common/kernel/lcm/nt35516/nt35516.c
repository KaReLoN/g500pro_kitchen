...
static void init_lcm_registers(void)
{
	...
	SPI_read_data( 0xC500,1);	//read out 0x55
	SPI_read_data( 0xC501,1);	//read out 0x16


	dataID=SPI_read_data( 0xDA00,1);//read out 0x88
	SPI_read_data( 0xDB00,1);	//read out 0x80  
	SPI_read_data( 0xDC00,1);	//read out 0x00
    ...
    send_ctrl_cmd(0x3600); send_data_cmd(0x00);//rotation 0XD0
