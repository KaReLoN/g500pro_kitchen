...
static struct i2c_board_info __initdata i2c_devs1[]={
	...
	{ I2C_BOARD_INFO("MT9P017AF", 0xff), },	//tangzp 120522  //这个地方写成MT9P017的slave addr
...
static int __init parse_tag_videofb_fixup(const struct tag *tags)
{
 ...
 extern int gk_Factory_RTC_Boot; //kaka_11_0622
void mt6577_fixup(struct machine_desc *desc, struct tag *tags, char **cmdline, struct meminfo *mi)
{
    ...
    for (; tags->hdr.size; tags = tag_next(tags)) {
	    ...
	    //kaka_11_1217 add
            if(g_boot_mode == (FACTORY_BOOT|0x3f00)){
            	g_boot_mode = FACTORY_BOOT;
            	gk_Factory_RTC_Boot = 1;
            }
			//kaka_11_1217 end
...
//add by zym 2012-03-15   //tangzp 120522
