...
#ifdef DEBUG_AUDDRV_IOCTL
#define PRINTK_AUDDRV_IOCTL(format, args...) xlog_printk(ANDROID_LOG_VERBOSE, "Sound", format, ##args )
#else
#define PRINTK_AUDDRV_IOCTL(format, args...)
#endif
