...
EXPORT_SYMBOL(g2d_drv_fb_deinit);
...
EXPORT_SYMBOL(g2d_drv_fb_dequeue_buffer);
...
EXPORT_SYMBOL(g2d_drv_fb_queue_buffer);
...
EXPORT_SYMBOL(g2d_drv_fb_fill_mirror_cmd);
